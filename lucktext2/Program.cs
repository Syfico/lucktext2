...
// Console.WriteLine("");
// Typewrite("Du får ursäkta mig, men jag är ivrig att få lära känna dig. Åh så ivrig!", 30);
// Console.WriteLine();
// Thread.Sleep(750);
// Console.Clear();

// Console.WriteLine("");
// Typewrite("Det var länge någon annan än jag befann sig så högt upp och så långt bort från civilisationen. Mhm, ja det var det.", 30);
// Console.WriteLine();
// Thread.Sleep(750);
// Console.Clear();

// Console.WriteLine("");
// Typewrite("Hur som helst, jag vill spela ett spel. Inte ett stort spel, åh nej. Men ett litet.", 30);
// Thread.Sleep(1500);
// Console.WriteLine("");
...
// Console.WriteLine();
// Console.CursorVisible = false;
// Typewrite($"Hej {name}, du svarade {answer1}, inte sant?", 30);
// Console.WriteLine();
// Thread.Sleep(1000);
// Console.Clear();
